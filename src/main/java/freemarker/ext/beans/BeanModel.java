...
import name.felixbecker.freemarkerdebug.FreemarkerTraceConfig;
    ...
    TemplateHashModelEx, AdapterTemplateModel, WrapperTemplateModel, TemplateModelWithAPISupport
{
        ...
        TemplateModelException
    {
    	...
    	/* === PATCHED === */
        	...
        	final long delta = endDate - startDate;
        	System.out.println("Evaluating " + object.getClass().getCanonicalName() + "." + key + " took " + delta +  "ms");
    	}
    	/* === END PATCHED === */
    }
